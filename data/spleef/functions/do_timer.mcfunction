...
execute if score Remaining spleef_data matches 1..3 run title @a subtitle [{"color": "blue", "score": { "objective": "spleef_data", "name": "Remaining" }}]
...
execute if score Remaining spleef_data matches 0 run title @a title {"color": "aqua", "text": "Game Over!"}
